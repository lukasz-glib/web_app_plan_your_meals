                ...
                <div class="schedules-content">
                    ...
                    <c:forEach items="${recipePlans}" var="RecipePlan">
                        <table class="table">
                            <thead>
                            <tr class="d-flex">
                                <th class="col-2">${RecipePlan.dayName}</th>
                                <th class="col-7"></th>
                                <th class="col-1"></th>
                                <th class="col-2"></th>
                            </tr>
                            ...
                            <c:forEach items="${RecipePlan.mealNameMap}" var="meals">
                                <c:forEach items="${meals.value}" var="recipe">
                                    <tr class="d-flex">
                                        <td class="col-2">${meals.key}</td>
                                        <td class="col-7">${recipe.name}</td>
                                        <td class="col-1 center">
                                            <a href="/app/plan/details/delete?id=${recipe.id}"
