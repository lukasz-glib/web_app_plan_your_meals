            ...
            <div class="dashboard-content border-dashed p-3 m-4 view-height">
                <div class="row border-bottom border-3 p-1 m-1">
                    <div class="col noPadding">
                        <h3 class="color-header text-uppercase">DODAJ PRZEPIS DO PLANU
                            <c:choose>
                ...
                <div class="schedules-content">
                    <form action="/app/recipe/plan/add" method="post">
                        <div class="col d-flex justify-content-end mb-2 noPadding">
                           <input type="submit" value="Wyślij" class="btn btn-success rounded-0 pt-0 pb-0 pr-4 pl-4" />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select name="recipe" class="form-control" id="recipe">
