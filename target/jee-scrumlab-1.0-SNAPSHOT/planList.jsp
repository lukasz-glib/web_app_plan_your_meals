            ...
            <div class="dashboard-content border-dashed p-3 m-4 view-height">
                ...
                <div class="schedules-content">
                    <table class="table border-bottom">
                            ...
                            <c:forEach items="${planDao}" var="plan" varStatus="i">
                                <tr class="d-flex">
                                    <td class="col-1">${i.count}</td>
                                    <td class="col-2">${plan.name}</td>
                                    <td class="col-7">${plan.description}</td>
                                    <td class="col-2 d-flex align-items-center justify-content-center flex-wrap"><a
                                            href="/app/plan/delete?id=${plan.id}" class="btn btn-danger rounded-0 text-light m-1">Usuń</a>
